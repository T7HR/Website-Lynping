...
import { getAuctionRequests, getAuctionResults, getAuctionStats, syncSellerEarningsFromResults } from "@/lib/auctionStore";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-6">
        ...
        <StatCard label="ยอดลงประมูลรวม" value={sellerEarning.toLocaleString("en-US")} />
