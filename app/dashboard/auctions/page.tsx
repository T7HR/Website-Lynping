...
export default async function DashboardAuctionsPage() {
  ...
  return <div><PageHeader title="จัดการรายการประมูล" /><div className="card p-5"><pre className="overflow-auto text-xs text-zinc-400">{JSON.stringify(rows, null, 2)}</pre></div></div>;
}
